...
class TestLists(TestCase):
    ...
    def test_at_least_one_a_or_b_is_on_list_c(self):
        ...
        self.assertEqual(result['summary']['fail'], 527)
    ...
    def test_at_least_one_a_is_on_list_b_if_c_is_at_least_d_and_e_or_f_is_not_g_or_h(self):
        ...
        result = test.test_doc(self.FILEPATH, t, lists=self.LISTS)
        self.assertEqual(result['summary']['success'], 48)
        self.assertEqual(result['summary']['fail'], 485)
        self.assertEqual(result['summary']['not_relevant'], 14)
        self.assertEqual(result['summary']['error'], 0)
    ...
    def test_at_least_one_a_is_on_list_b(self):
        ...
        result = test.test_doc(self.FILEPATH, t, lists=self.LISTS)
        self.assertEqual(result['summary']['success'], 48)
        self.assertEqual(result['summary']['fail'], 499)
        self.assertEqual(result['summary']['not_relevant'], 0)
        self.assertEqual(result['summary']['error'], 0)
    ...
    def test_a_or_b_is_on_list_c_if_d_is_at_least_e(self):
        ...
        self.assertEqual(result['summary']['fail'], 545)
        self.assertEqual(result['summary']['not_relevant'], 0)
        self.assertEqual(result['summary']['error'], 0)
