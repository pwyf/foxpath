...
class TestSimple(TestCase):
    ...
    def test_a_starts_with_b(self):
        ...
        self.assertEqual(result['summary'][t]['success'], 273)
        self.assertEqual(result['summary'][t]['fail'], 0)
    ...
    def test_a_or_b_or_c_or_d_or_e_for_any_f_is_less_than_g_months_ago(self, mock_datetime):
        ...
        result = test.test_doc(self.FILEPATH, [t])
        self.assertEqual(result['summary'][t]['success'], 132)
        self.assertEqual(result['summary'][t]['fail'], 141)
        self.assertEqual(result['summary'][t]['not_relevant'], 0)
        self.assertEqual(result['summary'][t]['error'], 0)
    ...
    def test_a_or_b_exists_if_c_is_at_least_d_and_e_is_not_f(self):
        ...
        result = test.test_doc(self.FILEPATH, [t])
        self.assertEqual(result['summary'][t]['success'], 13)
        self.assertEqual(result['summary'][t]['fail'], 178)
        self.assertEqual(result['summary'][t]['not_relevant'], 82)
        self.assertEqual(result['summary'][t]['error'], 0)
    ...
    def test_a_or_b_is_available_forward_if_c_is_at_least_d(self, mock_datetime):
        ...
        self.assertEqual(result['summary'][t]['fail'], 14)
        self.assertEqual(result['summary'][t]['not_relevant'], 239)
        self.assertEqual(result['summary'][t]['error'], 0)
    ...
    def test_a_or_b_is_available_forward_by_quarters_if_c_is_at_least_d(self, mock_datetime):
        ...
        result = test.test_doc(self.FILEPATH, [t])
        self.assertEqual(result['summary'][t]['success'], 0)
        self.assertEqual(result['summary'][t]['fail'], 34)
        self.assertEqual(result['summary'][t]['not_relevant'], 239)
        self.assertEqual(result['summary'][t]['error'], 0)
    ...
    def test_a_exists_if_b_is_at_least_c_and_d_or_e_is_not_f_or_g(self):
        ...
        result = test.test_doc(self.FILEPATH, [t])
        self.assertEqual(result['summary'][t]['success'], 0)
        self.assertEqual(result['summary'][t]['fail'], 257)
        self.assertEqual(result['summary'][t]['not_relevant'], 16)
        self.assertEqual(result['summary'][t]['error'], 0)
